  ...
  if (pets.length === 0) {
    return (
      <div className="text-center py-16 animate-zoomIn" id="pets-section">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2 animate-slideInLeft animate-delay-200">No pets found</h3>
    ...
    <div id="pets-section">
      <div className="mb-8">
        ...
        <p className="text-gray-600 animate-slideInLeft animate-delay-100 hover:text-gray-800 transition-colors duration-300">
          {pets.length} {pets.length === 1 ? 'pet' : 'pets'} waiting for their forever home
        </p>
      </div>
        ...
        {pets.map((pet, index) => (
          <PetCard
            ...
            className={`animate-fadeInUp ${
              ...
              index % 3 === 1 ? 'animate-delay-200' : 'animate-delay-300'
            }`}
          />
        ))}
      </div>
